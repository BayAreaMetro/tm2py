...
are controlled via the config, air_passenger section. 
ADDITIONAL DOCUMENTATION OF CONFIG TO COME
    [air_passenger]
    highway_demand_file = "demand_matrices\\highway\\air_passenger\\tripsAirPax{period}.omx"
    input_demand_folder = "nonres"
        ...
        for year in [self._start_year, self._end_year]:
            ...
            for airport in ["SFO", "OAK", "SJC"]:
                for direction in ["to", "from"]:
                    ...
                    file_path = os.path.join(self.root_dir, input_data_folder, file_name)
    ...
    def _export_result(self, demand):
        ...
        for period in self._periods:
            ...
            try:
                ...
                for name in self._mode_groups.keys():
