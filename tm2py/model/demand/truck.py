    ...
    def _setup_emme(self):
        ...
        matrices = {
            "FULL": [
                ...
                ("vsmtrk_demand", "very small truck daily demand"),
                ("smltrk_demand", "small truck daily demand"),
                ("medtrk_demand", "medium truck daily demand"),
                ("lrgtrk_demand", "large truck daily demand"),
            ],
            "ORIGIN": [
