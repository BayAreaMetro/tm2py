...
!!! warning "Documentation Update Required"
    This component documentation needs to be updated based on the SANDAG ABM Model Design document to ensure accuracy.
...
*Last updated: November 10, 2025 - Marked for SANDAG design alignment*top Location Choice
