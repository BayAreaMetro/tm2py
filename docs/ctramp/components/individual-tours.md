...
- Accurate choice alternatives for non-mandatory tour purposes
- Proper utility functions and explanatory variables
- Valid market segmentation and behavioral assumptions
- Correct integration with time window constraints

## Component Overview

The Individual Tours Model generates non-mandatory tours for discretionary activities like shopping, personal business, and social/recreational activities.

**Model Type**: To be verified against SANDAG design document
**Decision Unit**: Individual persons
**Purpose**: Generate discretionary tours within available time windows
