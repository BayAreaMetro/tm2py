...
- Correct model structure and joint tour composition alternatives
- Accurate household participation and coordination logic
- Proper utility functions and explanatory variables
- Valid market segmentation and behavioral assumptions
- Correct integration with household coordination constraints

## Component Overview

The Joint Tours Model determines when multiple household members participate in shared tours for activities like shopping, social visits, and recreation.

**Model Type**: To be verified against SANDAG design document
**Decision Unit**: Household level with person participation
**Purpose**: Coordinate shared travel among household members
