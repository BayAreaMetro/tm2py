...
- [Runtime Performance Benchmarking](testing/runtime-performance.md) - Empirical benchmarking results, including the `num_processors_transit_skim` sweep on a 176-core server